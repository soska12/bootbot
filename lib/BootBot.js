...
class BootBot extends EventEmitter {
  ...
  constructor (options) {
    ...
    this.graphApiVersion = options.graphApiVersion || 'v15.0';//'v2.12';
  ...
  sendRequest(body, endpoint, method) {
    ...
    console.log('url: '+`https://graph.facebook.com/${this.graphApiVersion}/me/${endpoint}?access_token=${this.accessToken}`)
